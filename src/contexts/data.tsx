...
export const dateTimeData: any[] = [
  ...
  { x: new Date(2023, 8, 11), y: 10 }, { x: new Date(2023, 9, 7), y: 30 },
  { x: new Date(2023, 10, 6), y: 15 }, { x: new Date(2023, 11, 30), y: 65 },
  { x: new Date(2023,12, 8), y: 90 }, { x: new Date(2024, 3, 8), y: 85 }
];